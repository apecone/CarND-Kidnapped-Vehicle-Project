 ...
 * @param (sig_x, sig_y) standard deviation of x and y for the distribution
 * @param (x_obs, y_obs) observed x and y coordinates
 * @param (mu_x, mu_y) average x and y coordinates for the distribution
 * @output Probability of observing x and y given a distribution.
 */
